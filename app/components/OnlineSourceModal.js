...
const OnlineSourceModal = (props: Props) => (
  <Modal open={props.open}>
    <Modal.Header>
      {props.onlineSource.id ? tr('Edit Online Source') : tr('New Online Source')}
    </Modal.Header>
    <Modal.Content>
      <Form onSubmit={propFunctionProxy.bind(null, props.onSave)} >
        <input type="hidden" name="id" value={props.onlineSource.id} />
        <Form.Group widths='equal'>
          <Form.Input label={tr('Name')} name='name' placeholder={tr('Name')} />
          <Form.Dropdown selection label={tr('Source Language')} name='source' options={languages} placeholder={tr('Source Language')} />
        </Form.Group>
        <Form.Group widths='equal'>
    ...
    <Modal.Actions>
      ...
      <Button positive type='submit' onClick={() => {console.log(this);debugger}}>
