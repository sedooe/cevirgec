...
import { Button, Dropdown, Image, Modal, Icon } from 'semantic-ui-react'
...
class ActiveDictionarySelector extends Component {
  ...
  render() {
    ...
    return (
      <div>
        <Dropdown placeholder={tr('No dictionary selected!')} fluid multiple search selection options={countryOptions} />
      </div>
    )
  }
}
